...
\subsection{The NR-IOC as the Scaling Limit}
...
\begin{enumerate}
\item \textbf{NR-IOC precision}: How many tower levels can be accurately encoded/decoded
...
\item \textbf{NR-IOC as the true ceiling}: The optical hardware is unlimited; scaling is bounded by electronic interface precision
